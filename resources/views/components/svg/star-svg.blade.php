<svg {{ $attributes->merge(['class' => 'h-4 w-4 mr-1']) }} fill="currentColor" 
    viewBox="-2.4 -2.4 28.80 28.80"
    id="meteor-icon-kit__solid-star" fill="none" xmlns="http://www.w3.org/2000/svg">
